...
`r citep('10.3201/eid1612.100589')` suggests surveillance improvements such as sampling according to age-dependent, temporal, or spatial patterns, sampling different sites of infection, and screening for multiple strains at once; however, this paper also considers only wild birds.

`r citep('10.1111/zph.12049')` advocates pig surveillance to improve our understanding of influenza's ecology and impact on human health, mostly on a laboratory (rather than farm or individual) level. (I was only allowed access to the abstract--I'm going to check with Dartmouth to see why--but this paper seems like an interesting extension idea).
