...
The goal of this document is to determine what culling scenario returns the simulation to equilibrium after an initial infection.
...
One initial infection is seeded on a farm. In this experiment, all farms have approximately 40 chickens.
...
Eleven percent of farms have grown in size by an order of magnititude, resulting in the doubling of total chicken population in the system. This growth occurs in the same region, representing an intensification of the industry in a particular area.
