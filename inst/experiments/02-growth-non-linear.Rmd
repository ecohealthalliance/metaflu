---
title: "Growth Scenario - One Initial Infection Seeded, Non-Linear Contact Rate"
author: "Cale Basaraba"
output: html_document
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, cache = TRUE, fig.width=10, fig.height=6)
devtools::load_all()
library(metaflu)
library(ggplot2)
library(dplyr)
...
This run of the simulator includes the implementation of a non-linear contact rate. 
...
total_i <- ggplot() +
  geom_histogram(data = g_tot_i, aes(x = total_i), binwidth = 0.5) +
  labs(title = paste0("Total Infections in ", l," Simulations"), x = "Total Infections", y = "Number of Simulations") +
  theme_minimal()
